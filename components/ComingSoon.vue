    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6 text-center">
        ...
        <p class="mt-3 text-gray-600">
          Welcome to my site! I'm a growing software developer soon to be software engineer. Looking forward to the making of this site to prove my skills, start learning about emerging technologies and about web development. Also plannig to do a blog to document all my journey.
        </p>
        <p class="mt-p4 pt-4 text-gray-800 border-t border-dashed">
          You can start following me in the next links:
        </p>
      </div>
      <div class="flex justify-center items-center pt-4 space-x-4">
        <a href="https://github.com/tupic98" target="_blank"><svg
          class="w-10 h-10 text-gray-600 hover:text-gray-800"
        ...
        <a href="https://twitter.com/AlejandroTupic" target="_blank"><svg
          class="w-10 h-10 text-gray-600 hover:text-gray-800"
          xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink"
          aria-hidden="true"
        ...
        <a href="https://www.polywork.com/raalvarenga" target="_blank" class="text-gray-600 hover:text-gray-800 text-2xl font-bold">
          Polywork
        </a>
        <a href="mailto:raalvarenga@rodrisw.dev" target="_blank">
          <svg
            class="w-10 h-10 text-gray-600 hover:text-gray-800"
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            preserveAspectRatio="xMidYMid meet"
            viewBox="0 0 24 24"
          ><path d="m21.5 4h-19c-1.378 0-2.5 1.122-2.5 2.5v11c0 1.378 1.122 2.5 2.5 2.5h19c1.378 0 2.5-1.122 2.5-2.5v-11c0-1.378-1.122-2.5-2.5-2.5zm.5 5.41-8.61 4.5c-.43.22-.91.34-1.39.34s-.95-.12-1.39-.34l-8.61-4.5v-2.26l9.53 4.98c.29.15.65.15.94 0l9.53-4.98z" fill="currentColor" /></svg>
        </a>
        <a href="https://www.linkedin.com/in/rodrigo-alvarenga-928b7a190/" target="_blank">
          <svg
            id="Capa_1"
